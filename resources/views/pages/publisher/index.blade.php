...
@section('title', 'Daftar Publisher')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active"><i class="fas fa-book mr-1"></i> Publisher</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('publisher.create') }}" class="btn btn-primary"><i class="fas fa-plus mr-1"></i>Tambah Publisher</a>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                <a class="dropdown-item" href="{{ route('publisher.edit', $publisher->id) }}">Edit</a>
                                                <a class="dropdown-item" href="#" onclick="confirmDelete({{ $publisher->id }}, '{{ $publisher->name }}')">Hapus</a>
                                            </div>
                                        </div>
                                        <form id="delete-form-{{ $publisher->id }}" action="{{ route('publisher.destroy', $publisher->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
...
function confirmDelete(publisherId, publisherName) {
    Swal.fire({
        ...
        text: "Setelah dihapus, Anda tidak dapat memulihkan buku \"" + publisherName + "\"!",
        icon: 'warning',
